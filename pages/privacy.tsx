    ...
    <div className="overflow-hidden col text-strong">
      ...
      <main className="pt-24 pb-16 px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
        <article className="prose dark:prose-invert prose-lg max-w-none">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li>
              <strong>Chat messages:</strong> To provide persistent chat
              history, message reactions, and reply functionality within Google
              Meet sessions.
            </li>
            <li>
              <strong>Meeting transcriptions:</strong> To enable the real-time
              transcription feature, transcription data is processed locally.
            </li>
            <li>
              <strong>User preferences:</strong> Settings such as dark mode
              preferences, auto-mute, auto-camera disable, and auto-join
              settings are stored locally in your browser.
            </li>
            <li>
              <strong>Participant information:</strong> To enable the attendee
              shuffling feature for meetings like standups and retrospectives.
            </li>
          </ul>
          <p className="mt-4">
            <strong>Important:</strong> Most of this data is processed and
            stored locally on your device and is not transmitted to our servers
            unless explicitly required for specific features.
          </p>

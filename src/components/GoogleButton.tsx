import { useSignInWithProvider } from "@firebase-oss/ui-react";
...
const GoogleButton = (props: Props) => {
  // const signInWithProvider = useSignInWithGoogle(auth);
  const [signInWithGoogle, googleUser, googleLoading, googleError] =
    useSignInWithGoogle(auth);

  const signIn = async () => {
    // const details = await signInWithGoogle();
    // console.log("Signed in with Google:", details);
  ...
  return (
    <button
      className="fui-button fui-button--secondary fui-provider__button"
      type="button"

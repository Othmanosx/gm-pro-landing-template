...
export const useZustandStore = create<Store>()(set => ({
  ...
  setShowNewMessageButton: showNewMessageButton => set(state => ({ ...state, showNewMessageButton })),
  reply: undefined,
  setReply: reply => set(state => ({ ...state, reply })),
  image: null,
  setImage: image => set(state => ({ ...state, image })),
  editedMessageId: '',
  setEditedMessageId: editedMessageId => set(state => ({ ...state, editedMessageId })),
  isShufflerOn: false,
  setIsShufflerOn: isShufflerOn => set(state => ({ ...state, isShufflerOn })),
}))
